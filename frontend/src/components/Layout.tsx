...
import { ShoppingCart, Menu, X, Printer, Shield } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              {/* Cart */}
              <Link to="/checkout" className="relative p-2 rounded-md hover:bg-primary/10 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="font-bold text-base text-primary">Creative Prints and Design</span>
              </div>
              <p className="text-sm text-muted-foreground">
                Professional 3D printing services for prototypes, custom parts, figurines, and more.
              </p>
            </div>
            ...
            {/* Contact */}
            <div>
              <h3 className="font-semibold text-sm mb-3 text-foreground">Contact</h3>
              <p className="text-sm text-muted-foreground">lanepeevy@gmail.com</p>
