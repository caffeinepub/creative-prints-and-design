...
import type { CustomOrder as _CustomOrder, ExternalBlob as _ExternalBlob, GalleryItem as _GalleryItem, OrderType as _OrderType, PaymentConfirmation as _PaymentConfirmation, Product as _Product, RoleAssignmentResult as _RoleAssignmentResult, StoreOrder as _StoreOrder, UnifiedOrder as _UnifiedOrder, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
    ...
    async completePasswordReset(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completePasswordReset(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPaymentConfirmations(): Promise<Array<PaymentConfirmation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPaymentConfirmations();
    ...
    async getAllStoreOrders(): Promise<Array<StoreOrder>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStoreOrders();
    ...
    async getAllUnifiedOrders(): Promise<Array<UnifiedOrder>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUnifiedOrders();
    ...
    async getGalleryItem(arg0: string): Promise<GalleryItem> {
        if (this.processError) {
            try {
                ...
                return from_candid_GalleryItem_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPrincipalByEmail(arg0: string): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrincipalByEmail(arg0);
    ...
    async hasPendingPasswordReset(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPendingPasswordReset(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerUserProfile(arg0: string, arg1: string, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async requestPasswordReset(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setRoleForCaller(arg0: UserRole): Promise<RoleAssignmentResult> {
        if (this.processError) {
            try {
                const result = await this.actor.setRoleForCaller(to_candid_UserRole_n9(this._uploadFile, this._downloadFile, arg0));
                return from_candid_RoleAssignmentResult_n38(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitCustomOrder(arg0: string, arg1: string, arg2: string | null, arg3: string | null, arg4: string, arg5: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomOrder(arg0, arg1, to_candid_opt_n40(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n40(this._uploadFile, this._downloadFile, arg3), arg4, await to_candid_opt_n41(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPaymentConfirmation(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPaymentConfirmation(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitStoreOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: bigint, arg8: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitStoreOrder(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, await to_candid_opt_n41(this._uploadFile, this._downloadFile, arg8));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateGalleryItem(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGalleryItem(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
    ...
    async verifyAndEnsureAdminStatus(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyAndEnsureAdminStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CustomOrder_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomOrder): Promise<CustomOrder> {
...
async function from_candid_GalleryItem_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GalleryItem): Promise<GalleryItem> {
...
async function from_candid_PaymentConfirmation_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentConfirmation): Promise<PaymentConfirmation> {
...
function from_candid_RoleAssignmentResult_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RoleAssignmentResult): RoleAssignmentResult {
    return from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
async function from_candid_StoreOrder_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StoreOrder): Promise<StoreOrder> {
    return await from_candid_record_n28(_uploadFile, _downloadFile, value);
}
async function from_candid_UnifiedOrder_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UnifiedOrder): Promise<UnifiedOrder> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        modelFile: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.modelFile)),
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        proofFile: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.proofFile),
...
async function from_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        paymentProof: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.paymentProof)),
        timestamp: value.timestamp,
        phone: value.phone,
...
async function from_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        customerName: value.customerName,
        description: value.description,
        productId: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.productId)),
        productName: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.productName)),
        ...
        timestamp: value.timestamp,
        phone: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.phone)),
        productPrice: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.productPrice)),
        productDescription: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.productDescription))
    };
}
...
function from_candid_variant_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "custom" in value ? OrderType.custom : "store" in value ? OrderType.store : value;
}
...
function from_candid_variant_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "alreadyAssigned" in value ? {
        __kind__: "alreadyAssigned",
        alreadyAssigned: value.alreadyAssigned
    } : "success" in value ? {
        __kind__: "success",
        success: from_candid_UserRole_n35(_uploadFile, _downloadFile, value.success)
    } : value;
}
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CustomOrder>): Promise<Array<CustomOrder>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CustomOrder_n12(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_GalleryItem>): Promise<Array<GalleryItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_GalleryItem_n18(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PaymentConfirmation>): Promise<Array<PaymentConfirmation>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PaymentConfirmation_n21(_uploadFile, _downloadFile, x)));
}
...
async function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StoreOrder>): Promise<Array<StoreOrder>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StoreOrder_n27(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_UnifiedOrder>): Promise<Array<UnifiedOrder>> {
    return await Promise.all(value.map(async (x)=>await from_candid_UnifiedOrder_n30(_uploadFile, _downloadFile, x)));
}
